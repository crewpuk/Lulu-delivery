...
<form form name="form1" method="post" action="">
	...
	$i = 0;
      ...
      <tr bgcolor="<?php echo $bg; ?>" class="linkBorder">
		...
		<td style="padding: 5px;" align="center"><a href="index.php?page=dashboard&sub=input_customer&vwUbah&no=<?php echo $data['code_customer']; ?>"><img src="<?php echo BASE; ?>images/16x16/edit.png" width="16" height="16" alt="vwUbah" title="Ubah"></a></td>
        <td style="padding: 5px;" align="center"><a href="index.php?page=dashboard&sub=input_customer&hapus&no=<?php echo $data['code_customer']; ?>"><img src="<?php echo BASE; ?>images/16x16/delete.png" width="16" height="16" alt="hapus" title="Hapus"></a></td>
      </tr>
		<?php } } ?>
	</table>
</form>
...
//Paging
    ...
    $sumBarang = mysql_fetch_array(mysql_query("SELECT count(`code_customer`) FROM `m_customer`"));
